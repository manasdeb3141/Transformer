...
def plot_mi_image(Q_MI_estimate, K_MI_estimate, V_MI_estimate, input_words, epoch, attention_layer, sentence_id):
    ...
    img = axs[0].imshow(Q_MI_estimate.T, vmin=0, vmax=0.1, interpolation='bicubic', cmap=plt.cm.jet)
    ...
    img = axs[1].imshow(K_MI_estimate.T, vmin=0, vmax=0.1, interpolation='bicubic', cmap=plt.cm.jet)
    ...
    img = axs[2].imshow(V_MI_estimate.T, vmin=0, vmax=0.1, interpolation='bicubic', cmap=plt.cm.jet)
...
def plot_QKV_entropy(QKV_entropy_mi, epoch, attention_layer, sentence_id):
    ...
    fig, axs = plt.subplots(1,3)
    # img = axs[0].imshow(Q_joint_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.Wistia)
    img = axs[0].imshow(Q_joint_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    axs[0].set_aspect('equal')
    ...
    # img = axs[1].imshow(K_joint_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.Wistia)
    img = axs[1].imshow(K_joint_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    ...
    # img = axs[2].imshow(V_joint_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.Wistia)
    img = axs[2].imshow(V_joint_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    ...
    fig, axs = plt.subplots(2,3, figsize=(2, 16))
    img = axs[0, 0].imshow(Q_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    ...
    img = axs[0, 1].imshow(K_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    axs[0, 1].set_aspect('auto')
    axs[0, 1].set_xticks([0], [""])
    # axs[0, 1].set_yticks(range(0, len(input_words)), input_words, rotation=0)
    axs[0, 1].set_yticks(range(0, len(input_words)), [""] * len(input_words), rotation=0)
    axs[0, 1].set_title(f"K")
    # fig.colorbar(img, ax=axs[0, 1])
    img = axs[0, 2].imshow(V_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    axs[0, 2].set_aspect('auto')
    axs[0, 2].set_xticks([0], [""])
    # axs[0, 2].set_yticks(range(0, len(input_words)), input_words, rotation=0)
    axs[0, 2].set_yticks(range(0, len(input_words)), [""] * len(input_words), rotation=0)
    axs[0, 2].set_title(f"V")
    # fig.colorbar(img, ax=axs[0, 2])

    img = axs[1, 0].imshow(Q_prime_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    ...
    img = axs[1, 1].imshow(K_prime_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    axs[1, 1].set_aspect('auto')
    axs[1, 1].set_xticks([0], [""])
    # axs[1, 1].set_yticks(range(0, len(input_words)), input_words, rotation=0)
    axs[1, 1].set_yticks(range(0, len(input_words)), [""] * len(input_words), rotation=0)
    axs[1, 1].set_title(f"K'")
    # fig.colorbar(img, ax=axs[1, 1])
    img = axs[1, 2].imshow(V_prime_entropy_estimate, vmin=0, vmax=max_val, interpolation='bicubic', cmap=plt.cm.jet)
    axs[1, 2].set_aspect('auto')
    axs[1, 2].set_xticks([0], [""])
    # axs[1, 2].set_yticks(range(0, len(input_words)), input_words, rotation=0)
    axs[1, 2].set_yticks(range(0, len(input_words)), [""] * len(input_words), rotation=0)
