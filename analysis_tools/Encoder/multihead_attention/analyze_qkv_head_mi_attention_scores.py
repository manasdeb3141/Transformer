...
def get_attention_scores(analyzer : TransformerAnalyzer, head_id, sentence_id, N_src_tokens, attention_layer) -> np.array:
...
def main():
    ...
    if save_file.exists():
        ...
        attention_scores = get_attention_scores(analyzer, head_id, sentence_id, N_src_tokens, attention_layer)
