...
def main():
    print("Computing the cross-attention QKV inputs ...")
    ...
    plot_cross_atten_QKV_MI(QKV_MI_dict, epoch, decoder_token_id, attention_layer)
    plot_cross_atten_QKV_prime_MI(cross_QKV_prime_MI_dict, epoch, decoder_token_id, attention_layer)

    plot_MI_bars(cross_QKV_prime_MI_dict, word_list) 

    plot_JSD_estimate(cross_QKV_prime_MI_dict, epoch, decoder_token_id, attention_layer)
